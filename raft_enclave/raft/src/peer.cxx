...
void peer::send_req(ptr<req_msg> &req, rpc_handler &handler) {
    ...
    rpc_handler h = (rpc_handler) std::bind(&peer::handle_rpc_result, this, req, pending, std::placeholders::_1,
                                            std::placeholders::_2);
    rpc_->send(req, h);
}

void peer::handle_rpc_result(ptr<req_msg> &req, ptr<rpc_result> &pending_result, ptr<resp_msg> &resp,
